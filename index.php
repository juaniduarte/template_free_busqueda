            ...
            <div class="container">
                <div class="row no-gutters">
                    <div class="slider-text fadeInUp animated order-2 order-sm-1  col-sm-6 col-md-7">
                        <h1 class="slider-title">Gamana <span class="strong">– Technology</span></h1>
                        <p class="slider-content">A qualidade que vocé conhece E o  estilo que vocé já Tem.<br>
                        Hurry to go affiliate on this day successfully with BLURB Theme.</p>
                        <a href="https://www.gamana.com.br/" target="_blank" class="btn btn-primary wd-shop-btn slider-btn">
                            Go to Site <i class="fa fa-arrow-right" aria-hidden="true"></i>
                        </a>
                    </div>
                    <div class="col-sm-6 col-md-5 order-1 order-sm-2 slider-img fadeInDown animated">
                        <img src="img/1366_2000.png" alt="">
                    </div>
                </div>
            </div>
			</div>
									...
									<div class="row">
										<div class="col-md-6 p0 row">
											...
											<div class="col-8 col-md-8 p0">
												...
												<span class="sub-title">Ceo at <a href="https://www.themeim.com/">ThemeIM</a></span>
											</div>
										</div>
    		...
    		<div class="row">
    			...
    			<div class="col-md-6 text-right">
    				<div class="call-to-action-buy-now wow bounceInRight animated" data-wow-delay="600ms">
    					<!-- By Theme -->
						<a href="https://themeforest.net/item/blurb-price-comparison-affiliate-website-multivendor-store-and-product-review-html5-template/20880845?ref=themeim" class="btn btn-primary wd-shop-btn">
